...
module ViewComponent
  module Form
    class Builder < ActionView::Helpers::FormBuilder
      ...
      class_attribute :components_namespaces, default: [ViewComponent::Form]

      class << self
        def inherited(base)
          base.components_namespaces = components_namespaces.dup

          super
        end

        # IMPROVMENT: raise exception if namespace call more than once
        def namespace(namespace)
          components_namespaces.prepend namespace
        end
      end
      ...
      def component_klass(component_name)
        @__component_klass_cache[component_name] ||= begin
          component_klass = self.class.components_namespaces.filter_map do |namespace|
